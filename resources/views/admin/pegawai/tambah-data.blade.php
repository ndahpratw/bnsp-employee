            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body pt-3">
                        ...
                        <form action="{{ route('pegawai.store') }}" method="POST" enctype="multipart/form-data" id="form">
                            @csrf
                            ...
                            <div class="row m-3">
                                ...
                                <div class="col-md-6 mt-2">
                                    ...
                                    <input type="text" name="NIK" class="form-control @error('NIK') is-invalid @enderror shadow-none" id="NIK" value="{{ old('NIK') }}" placeholder="Masukkan nomor induk penduduk">
                                ...
                                <div class="col-md-6 mt-2">
                                    ...
                                    <input type="text" name="NIP" class="form-control @error('NIP') is-invalid @enderror shadow-none" id="NIP" value="{{ old('NIP') }}" placeholder="Kosongkan jika masih belum memiliki NIP">
                                    @error('NIP') 
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div> 
                                ...
                                <div class="col-md-4 mt-2">
                                    ...
                                    <select class="form-select @error('jenis_kelamin') is-invalid @enderror" id="jenis_kelamin" aria-label="Default select example" name="jenis_kelamin">
                                        <option selected disabled value="none">Pilih Jenis Kelamin</option>
                                ...
                                <div class="col-md-4 mt-2">
                                    ...
                                    <select class="form-select @error('agama') is-invalid @enderror" id="agama" aria-label="Default select example" name="agama">
                                        <option selected disabled value="none">Pilih Agama</option>
                                ...
                                <div class="col-md-4 mt-2">
                                    ...
                                    <select class="form-select @error('status_menikah') is-invalid @enderror" id="status_menikah" aria-label="Default select example" name="status_menikah">
                                        <option selected disabled value="none">Pilih Status Menikah</option>
                                ...
                                <div class="col-md-4 mt-2">
                                    ...
                                    <select class="form-select @error('peran') is-invalid @enderror" aria-label="Default select example" name="peran" id="peran">
                                        <option selected disabled value="none">Pilih Peran / Jabatan</option>
                                ...
                                <div class="col-md-4 mt-2">
                                    ...
                                    <select class="form-select @error('status_kepegawaian') is-invalid @enderror" aria-label="Default select example" name="status_kepegawaian" id="status_kepegawaian">
                                        <option selected disabled value="none">Pilih Status Kepegawaian</option>
                                ...
                                <div class="col-md-3 mt-2">
                                    ...
                                    <select class="form-select @error('pendidikan_terakhir') is-invalid @enderror" aria-label="Default select example" name="pendidikan_terakhir" id="pendidikan_terakhir">
                                        <option selected disabled value="none">Pilih Pendidikan Terakhir</option>
                                ...
                                <div class="col-md-3 mt-2">
                                    ...
                                    <input type="text" name="tahun_lulus" class="form-control @error('tahun_lulus') is-invalid @enderror shadow-none" id="tahun_lulus" value="{{ old('tahun_lulus') }}" placeholder="Masukkan tahun lulus">
                                ...
                                <div class="col-md-4 mt-2">
                                    ...
                                    <input type="text" name="no_telepon" class="form-control @error('no_telepon') is-invalid @enderror shadow-none" id="no_telepon" value="{{ old('no_telepon') }}" placeholder="Contoh : 6282.............">
