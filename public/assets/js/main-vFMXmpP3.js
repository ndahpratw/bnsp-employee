            ...
            for (let r = 0, l = n.length; r < l; r += 1) {
                ...
                a !== void 0 &&
                    ...
                    ($(t[o]) && $(s[o])
                        ...
                        : !$(t[o]) && $(s[o])
                        ? ((t[o] = {}),
                          s[o].__swiper__ ? (t[o] = s[o]) : G(t[o], s[o]))
                        : (t[o] = s[o]));
            }
        }
    }
...
function me(t) {
    ...
    const d = i > r ? "next" : "prev",
        ...
        f = () => {
            ...
            let m = r + u * (i - r);
            if (
                (c(m, i) && (m = i), e.wrapperEl.scrollTo({ [s]: m }), c(m, i))
            ) {
...
function V(t, e) {
    return (
        e === void 0 && (e = ""), [...t.children].filter((i) => i.matches(e))
    );
}
function q(t) {
    try {
...
function Fe() {
        ...
        if (
            ...
            if (i.slidesPerView === "auto") {
                ...
                (C = (r - (i.slidesPerView - 1) * S) / i.slidesPerView),
                    i.roundLengths && (C = Math.floor(C)),
                    c[w] &&
                        (c[w].style[t.getDirectionLabel("width")] = `${C}px`);
    ...
    if (a && i.loop) {
        ...
        for (
            let T = 0;
            T < t.virtual.slidesBefore + t.virtual.slidesAfter;
            T += 1
        )
            ...
            ? a.controller.control.forEach((z) => {
                  !z.destroyed &&
                      ...
                      z.loopFix({
                          ...b,
                          slideTo:
                              z.params.slidesPerView === u.slidesPerView
                                  ? i
                                  : !1,
                      });
              })
    ...
    for (
        ...
        typeof d[x + I] < "u"
            ? (m || (u >= d[x] && u < d[x + I])) &&
              ((v = x), (y = d[x + I] - d[x]))
            : (m || u >= d[x]) &&
              ((v = x), (y = d[d.length - 1] - d[d.length - 2]));
    }
    let g = null,
        E = null;
    l.rewind &&
...
class D {
        ...
        (i.rtl && e === "rtl") ||
            ...
            i.rtl
                ...
                : (i.el.classList.remove(
                      `${i.params.containerModifierClass}rtl`
                  ),
                  (i.el.dir = "ltr")),
            i.update());
    }
    ...
    init(e) {
        ...
        return (
            i.isElement &&
                n.push(...i.hostEl.querySelectorAll('[loading="lazy"]')),
            n.forEach((r) => {
                r.complete
                    ? W(i, r)
...
function Bt(t, e) {
    function i(s) {
        s.target === t &&
            (e.call(t, s), t.removeEventListener("transitionend", i));
    }
...
function Rt({ swiper: t, duration: e, transformElements: i, allSlides: s }) {
    ...
    if (t.params.virtualTranslate && e !== 0) {
        ...
        s
            ? (o = i)
            : (o = i.filter((a) => {
                  const d = a.classList.contains("swiper-slide-transform")
                      ? r(a)
                      : a;
    ...
    const s = () => {
            const { slides: r, slidesSizesGrid: l, params: o, size: a } = t,
                ...
                u = p
                    ? 0.5
                    : Math.min(
                          Math.max(o.materialEffect.slideSplitRatio, 0),
                          1
                      ),
                m = p
                    ? 0.5
            ...
            for (let v = 0; v < r.length; v += 1) {
                ...
                M < 0 && (M = 0),
                    ...
                    S.forEach((L) => {
                        let O = parseFloat(
                            L.getAttribute("data-swiper-material-scale")
                        );
                        (Number.isNaN(O) || (!O && O !== 0)) && (O = 1),
                            (L.style.transform = `scale(${
                                1 + (O - 1) * (1 - M)
                            })`);
                    }),
                    t.isHorizontal()
                        ...
                        : ((g.style.height = `${100 * M}%`),
                          (g.style.transform = `translate3d(0, ${
                              C - P
                          }px, 0)`));
            }
        },
    ...
    e("beforeInit", () => {
        ...
        e("slidesUpdated", () => {
            if (
                ...
                t.snapGrid.push(
                    r + t.slidesSizesGrid[0] + t.params.spaceBetween
                );
            }
