...
CheckForm(nama, NIK, NIP, tempat_lahir, tanggal_lahir, jenis_kelamin, agama, status_menikah, peran, status_kepegawaian, bergabung, nama_instansi, pendidikan_terakhir, jurusan, tahun_lulus, email, telepon, alamat)
})

function CheckForm(nama, NIK, NIP, tempat_lahir, tanggal_lahir, jenis_kelamin, agama, status_menikah, peran, status_kepegawaian, bergabung, nama_instansi, pendidikan_terakhir, jurusan, tahun_lulus, email, telepon, alamat){
    ...
    else if ((namaValue != '') || (!namaValue.match(/^[a-zA-Z]*$/))){
    ...
    else if ((NIK_value != '') || (NIK_value.match(/^[a-zA-Z]*$/)) || (NIK_value.length == 16)) {
    ...
    else if ((tempat_lahir_value != '') || (!tempat_lahir_value.match(/^[a-zA-Z]*$/))) {
    ...
    console.log(pendidikan_terakhir)
    ...
    else if ((tahun_lulus_value != '') || (tahun_lulus_value.match(/^[a-zA-Z]*$/)) || (tahun_lulus_value.length == 4)) {
    ...
    else if ((email_value != '') || (!namaValue.match(/^([a-z0-9_\.-]+)@([\da-z\.-]+)\./))){
    ...
    else if ((telepon_value != '') || (telepon_value.match(/^[a-zA-Z]*$/)) || (telepon_value.length == 13)) {
    ...
    if (
        ...
        alert('Terdapat kolom mandatory yang masih belum diisi');
    } else if (
        (!namaValue.match(/^[a-zA-Z]*$/)) 
    ) {
        alert('Terdapat inputan yang tidak sesuai ketentuan');
    } else {
        form.submit();
    }
}